output "group_names" {
  value = {
    ...
    identity_contributors  = azuread_group.identity_contributors.display_name
    ...
    corp_contributors      = azuread_group.corp_contributors.display_name
    online_contributors    = azuread_group.online_contributors.display_name
